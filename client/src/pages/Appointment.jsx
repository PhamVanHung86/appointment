  ...
  const getAvailableSlots = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        // increase current time by 30 minute
  ...
  return (
    docInfo && (
      <div>
        ...
        {/* ------------ Booking Slots ------------ */}
        <div className="sm:ms-72 sm:pl-4 mt-4 font-medium text-gray-700">
          <p>Booking slots</p>
            ...
            {docSlots.length &&
              docSlots[slotIndex].map((item, index) => (
                <p
                  ...
                  className={`text-sm font-light flwx-shrink-0 px-5 py-2 rounded-full cursor-pointer`}
                  key={index}
                >
