    ...
    <div>
      ...
      <div className="flex flex-col justify-center md:flex-row my-10 gap-10 mb-28 text-sm">
        ...
        <div className="flex flex-col justify-center items-start gap-6">
          ...
          <p className="text-gray-500">sadfds</p>
          <p className="text-gray-500">asdfsadf</p>
          <p className="font-semibold text-lg text-gray-600">asdfsadf</p>
          <p className="text-gray-600">asdfsdaf</p>
